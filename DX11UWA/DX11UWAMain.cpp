...
bool DX11UWAMain::Render(void)
{
	...
	//Before render, get render stenc view
	m_sceneRenderer->RenderToShadow();
	...
	context->ClearDepthStencilView(m_deviceResources->GetDepthStencilView(), D3D11_CLEAR_DEPTH, 1.0f, 0);// | D3D11_CLEAR_STENCIL, 1.0f, 0);
